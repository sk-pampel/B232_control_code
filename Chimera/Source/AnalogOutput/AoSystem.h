...
class AoSystem : public IChimeraSystem {
	...
	private:
		...
		QLabel* dacTitle = nullptr;
		CQPushButton* dacSetButton = nullptr;
		CQPushButton* zeroDacsButton = nullptr;
		CQCheckBox* quickChange = nullptr;
		...
		double dacTriggerTime = 0.0005;
		bool roundToDacPrecision = false;
